...
ckpt = torch.load('/home/crist_tienngoc/alcon_spc/yolov7/runs/train/yolov7/weights/best.pt')
# reparameterized model in cfg/deploy/*.yaml
model = Model('cfg/deploy/yolov7.yaml', ch=3, nc=21).to(device)
...
torch.save(ckpt, 'cfg/deploy/yolov7_best.pt')